...
\onslide<2->{
	\node[above right = of QMA.north east] (LHP) {\color{red} {Finding ground states}};
...
\onslide<2->{
As a first step to unifying these approaches, we give a first ``knowledge compilation map'' (after Darwiche \& Marquis' seminal work) for quantum information~\cite{vinkhuijzen2024a}:
}
...
\phantom{\cite{quist2024advancing,thanos2024automated,limdd,vinkhuijzen2024a,mei2024simulating,mei2024eq,ours}}
