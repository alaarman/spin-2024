...
\lstick{\ket{a}} & & \qw &  \ctrl{2} 	&\qw	& \qw      & \qw  \\
\lstick{\ket{b}} & & \qw &  \ctrl{1}	&\qw 	& \qw      & \qw \\
\lstick{x := \ket{0}} &  & \qw & \targ  &\qw 	    & \ctrlo{1} & \qw \\  
\lstick{\ket{c}} & & \qw &     \qw 	&\qw	& \ctrlo{1} & \qw  \\
\lstick{y := \ket{1}} &  & \qw &     \qw   &\qw 	& \targ & \qw 
